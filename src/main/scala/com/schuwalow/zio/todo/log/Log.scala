...
object Log {
  ...
  trait UnsafeLogger {
    ...
    def trace[A: Show](a: => A)(implicit line: sourcecode.Line, file: sourcecode.File): Unit
    def debug[A: Show](a: => A)(implicit line: sourcecode.Line, file: sourcecode.File): Unit
    def info[A: Show](a: => A)(implicit line: sourcecode.Line, file: sourcecode.File): Unit
    def warn[A: Show](a: => A)(implicit line: sourcecode.Line, file: sourcecode.File): Unit
    def error[A: Show](a: => A)(implicit line: sourcecode.Line, file: sourcecode.File): Unit
  }
  ...
  trait Service[R] extends Serializable {
    ...
    def unsafeInstance: ZIO[R, Nothing, UnsafeLogger]
  }
}
