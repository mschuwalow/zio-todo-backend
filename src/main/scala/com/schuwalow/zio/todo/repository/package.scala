...
package object repository extends TodoRepository.Service[TodoRepository] {
  ...
  override def getById(id: TodoId): ZIO[TodoRepository, Nothing, Option[TodoItem]] = ZIO.accessM(_.todoRepository.getById(id))
  ...
  override def update(id: TodoId, todoItemForm: TodoItemPatchForm): ZIO[TodoRepository, Nothing, Option[TodoItem]] = ZIO.accessM(_.todoRepository.update(id, todoItemForm))
